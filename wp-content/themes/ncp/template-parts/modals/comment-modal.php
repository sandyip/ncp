    ...
    <div class="makura-modal-body p-sm-48 p-24">
      ...
      <div class="comment-form">
        <div class="row">
          <div class="col-sm-6">
            <div class="input-field">
              <input type="text" id="first-name" name="first-name" placeholder="First Name" value="" />
            </div>
          </div>
          <div class="col-sm-6">
            <div class="input-field">
              <input type="text" id="last-name" name="last-name" placeholder="Last Name" value="" />
            </div>
          </div>
          <div class="col-md-12">
        ...
        <div class="text-center rounded-48 py-12 px-36 bg-submit-bg">
          <a href="#" class="text-16 leading-149 text-white">Submit Comment</a>
        </div>
      </div>
    </div>
  </div>
